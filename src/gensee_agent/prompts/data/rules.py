...
1. In every response, you must include a <title> tag that summarizes your response in less than 20 words. This title will be used as both the subject line to the user and as the unique identifier for the message in the conversation history. The title should be unique, concise and descriptive of the content of your response.
